...
class Window(QWidget):
    ...
    def initView(self):
        ...
        self.path.arcTo(graphicalCenterC1[0] - graphicR, graphicalCenterC1[1] - graphicR // 2, graphicR, graphicR, 180, -startAngle)
...
graphicalCenterC1 = [graphicStart[0] + graphicR * cos(startAngle - pi / 2),
                     graphicStart[1] + graphicR * sin(startAngle - pi / 2)]

centerC2 = [end[0] + r * cos(endAngle - pi / 2),
            end[1] + r * sin(endAngle - pi / 2)]

graphicalCenterC2 = [graphicEnd[0] + graphicR * cos(endAngle - pi / 2),
                     graphicEnd[1] + graphicR * sin(endAngle - pi / 2)]
